...
class PredictionEngine {
    ...
    calculateGeminiMatchupAdjustment(factors) {
        ...
        // Capping estricto (±10% máximo absoluto final, por regla estricta de validación)
        const multA = Math.max(0.90, Math.min(1.10, rawAdjustmentA));
        const multB = Math.max(0.90, Math.min(1.10, rawAdjustmentB));
